...
public class MyCarMainActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.my_car_main, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_intro) {
            startActivity(new Intent(MyCarMainActivity.this,MainActivity_Introduction.class));
        } else if (id == R.id.nav_mycar) {

        } else if (id == R.id.nav_servic) {
